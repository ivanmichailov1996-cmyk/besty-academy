            ...
            <li key={lesson.slug}>
              {lesson.ready ? (
                <Link
                  ...
                  className={`group flex items-center justify-between gap-4 rounded-2xl ${surface} p-4 sm:p-5 hover:brightness-[0.97] hover:scale-[1.01] transition-all duration-700 ease-[cubic-bezier(0.19,1,0.22,1)]`}
                >
                  <div>
