      ...
      <div className="grid lg:grid-cols-[220px_1fr] gap-8">
        ...
        <div className="space-y-16 min-w-0">
          ...
          <section id="pay" className="reveal scroll-mt-24">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-5">
              <Card tone="dark">
                ...
                <ul className="text-sm text-white/85 space-y-1.5 list-disc pl-4">
                  <li>29 числа — аванс за отработанное время с 1 по 15 число.</li>
                  <li>14 числа — зарплата за отработанное время с 16 по последний день предыдущего месяца.</li>
                </ul>
              </Card>
              <Card tone="accent">
            ...
            <div className="mt-4">
            <Card>
              <p className="font-bold text-brand-ink mb-2">Премии и бонусы</p>
              <p className="text-sm text-neutral-700 mb-3">
                Кроме оклада, в Besty действует бонусная программа — несколько видов премий, которые можно
                получать одновременно, если выполняются условия по каждой из них.
              </p>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-left text-neutral-500">
                      <th className="py-1.5 pr-4 font-bold">Премия</th>
                      <th className="py-1.5 pr-4 font-bold">Условия</th>
                      <th className="py-1.5 font-bold">Размер</th>
                    </tr>
                  </thead>
                  <tbody className="text-neutral-800">
                    {[
                      [
                        "За безупречность (ежемесячно)",
                        "80+ часов за месяц, без нарушений дисциплины и отстранений",
                        "20% от «часы × ставка»",
                      ],
                      [
                        "За полную занятость — 4+ дня, 40 ч/нед (ежемесячно)",
                        "Подписан график на 40 ч/нед, без нарушений и отстранений",
                        "10% к ставке",
                      ],
                      [
                        "За полную занятость — любые часы, включая ночные (ежемесячно)",
                        "40 ч/нед в любое время суток, без нарушений и отстранений",
                        "20% к ставке",
                      ],
                      [
                        "Процент от личных продаж (ежемесячно)",
                        "Нет неявок (кроме больничного), нет нарушений дисциплины",
                        "1% от личных продаж, максимум 15 000 ₽",
                      ],
                      [
                        "«Лучший работник» (по итогам месяца)",
                        "Выбирает комиссия менеджеров: дисциплина, КЛН, командная работа",
                        "Фиксированная сумма",
                      ],
                      [
                        "«Приведи друга» (единовременно)",
                        "Друг принят и отработал 2 месяца",
                        "Фиксированная сумма, выплата в ближайшую зарплату",
                      ],
                      ...
                      <tr key={name} className="border-t border-neutral-100 align-top">
                        ...
                        <td className="py-1.5 pr-4 text-neutral-600">{condition}</td>
              ...
              <p className="text-xs text-neutral-500 mt-3">
                Бонусные выплаты могут быть ограничены или отменены при невыполнении должностных обязанностей,
                обоснованных жалобах гостей, нарушении дисциплины или наличии дисциплинарных взысканий.
              </p>
            </Card>
            </div>
